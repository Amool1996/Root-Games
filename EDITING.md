...
| `ra-data/qr.svg` | the QR code (generated by `cluster/make_qr.py`) |
| `.github/workflows/pages.yml` | publishes the game files to https://amool1996.github.io/Root-Games/ on every push |
| `ra-data/voice/` | optional MP3 narration (see §4) |
| `ra-data/music/` | optional MP3 music per screen (built-in music plays otherwise) |
